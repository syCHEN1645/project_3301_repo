...
# This function is adjusted to change result output path so the automated process is more succinct
# Adjusted run_path should be like:
# base_path/image_name
# All generated files should be put inside
def main():
    args = read_args()
