...
def main():
    ...
    for index in camera_index_list:
        ...
        print(f"Key in name for camera {index}: ")
        camera_name = (str)(input())
        print(f"Key in wellhead name for camera {index}: ")
        wellhead_name = (str)(input())
        print(f"Key in gauge name for camera {index}: ")
        gauge_name = (str)(input())
